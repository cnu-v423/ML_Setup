import argparse
from ensemble_triton_predictor_with_waterbody import EnsemblePredictor
import os
...
def main():
    ...
    model_paths = {
        ...
        'building': ("vegitation",0.25, "input_3","model_1"),
        # 'building': ('building_unet_finetuned_256', 0.3, 'input', 'output'),
