...
class EnsemblePredictor:
    ...
    def __init__(self, config_path='config.yaml', class_priority=None):
    ...
    def resolve_conflicts(self, predictions, confidence_threshold=0.5):
        ...
        final_mask = np.zeros_like(water_pred, dtype=np.uint8)
    ...
    def resolve_conflicts_new(self, predictions):
        ...
        Strategy:
        - If confidence > threshold, mark as building
        - Else, mark as background
        """
        building_conf = predictions['building']
        building_mask = building_conf > self.thresholds['building']
    ...
    def predict(self, image_path, output_path):
        ...
        # print("The predict is about to start")
