import argparse
from backbone_ensemble_predictor_without_triton import EnsemblePredictor
import os
...
def main():
    ...
    # parser.add_argument('--config', default='/home/gpuserver/vinay/attention_unet/src/config.yaml',
    ...
    model_paths = {
        'building': (args.building_model, 0.343),
    ...
    # clipped_input = os.path.join(os.path.dirname(args.output_path), f"{input_filename}.tif")
    clipped_input = args.input_image
    ...
    prediction_output = os.path.join(os.path.dirname(args.output_path),f"{os.path.splitext(os.path.basename(args.output_path))[0]}_mutliclass.tif")
